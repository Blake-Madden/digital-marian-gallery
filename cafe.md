...
<p style="text-align:center;">
  <a href="{{ '/images/data-report-at-coffee-shop-autumn.png' | relative_url }}">
    <img class="portrait" src="{{ '/images/data-report-at-coffee-shop-autumn.png' | relative_url }}" alt="Afternoon Blend - ETL & PSL" title="Afternoon Blend - ETL & PSL"><br>
  </a>
</p>
...
<p style="text-align:center;">
<a href="{{ '/images/data-report-at-winter-coffee-shop.png' | relative_url }}">
    <img class="portrait" src="{{ '/images/data-report-at-winter-coffee-shop.png' | relative_url }}" alt="Undoing the Knots" title="Undoing the Knots"><br>
</a>
</p>
...
<p style="text-align:center;">
  <a href="{{ '/images/springtime-coffeeshot.png' | relative_url }}">
    <img class="portrait" src="{{ '/images/springtime-coffeeshot.png' | relative_url }}" alt="Springing Forth" title="Springing Forth"><br>
  </a>
</p>
